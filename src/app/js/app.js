(function($) {
  ...
  function init_change_mode() {
    $("#changeMode").on("click", function() {
      console.log("darkMode = " + darkMode);
      var $body = $("body");
      if (darkMode == true) {
        $body.removeClass("yb-dark-skin uk-light");
        darkMode = false;
        $("#changeMode").html('<i class="yb-inner-link uil uil-moon">')
      }
      else {
        $body.addClass("yb-dark-skin uk-light");
        darkMode = true;
        $("#changeMode").html('<i class="yb-inner-link uil uil-sun">')
      }
    }); 
  }
  ...
  function init_typed() {
    ...
    if ($typed.length) {
      var typed = new Typed("#typed", {
        strings: ["Student @CityU HK", "Sofware Engineer", "Data Scientist"],
        loop: true,
        typeSpeed: 70
      });
    }
